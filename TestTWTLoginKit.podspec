#
#  Be sure to run `pod spec lint TestTWTLoginKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "A short description of TestTWTLoginKit.A short description of TestTWTLoginKitA short descrip"
  ...
  s.author             = { "waterwang1992" => "1225379577@qq.com" }
  # Or just: s.author    = "waterwang1992"
  # s.authors            = { "waterwang1992" => "1225379577@qq.com" }
  # s.social_media_url   = "http://twitter.com/waterwang1992"
  ...
  #
   ...
   s.source_files = 'TestTwitterKit','TestLoginKit/TestTwitterKit/**/*.{h,m}'
